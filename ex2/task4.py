...
def main():
    url = "https://www.acc.umu.se/~coppelia/pooh/stories/ch1.html"
    ...
    for index, line in enumerate(document.stripped_strings):
    ...
    tableLineWords = """<br><br><h2 align="center">Number of words per line</h2><table border='1'>
    ...
    <table class ="verbTable" border='1'><tr><th>Past Verb</th><th>Appearances</th></tr>""" + generate_table(past.items()) + """
    ...
    css = """<head><style>table{font-family:arial;border-collapse:collapse;}
    ...
    pdfkit.from_string(css + outputText, "task4.pdf")
